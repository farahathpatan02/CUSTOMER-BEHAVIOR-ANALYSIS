...
PostgreSQL (pgAdmin) – SQL queries and analysis

MySQL / SQL Server – Database querying
...
Designed presentation for CEO & CMO
...
Young adult and middle-aged customers contribute the highest sales.
...
Promote subscription model to increase customer lifetime value.
